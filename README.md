...
1. Clone the repository: ```git clone https://github.com/souviksenapati/Birds-Sound-Identification-System```
...
🚀 **Application:** https://huggingface.co/spaces/souviksenapati/Birds-Sound-Classification-Using-DL
